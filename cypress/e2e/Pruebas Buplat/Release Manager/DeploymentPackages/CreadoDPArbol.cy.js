...
describe('Ingresamos Login',() =>{
    it('Creamos DP desde el Arbol',() =>{
     ...
     //Activamos El contenedor desde la Tabla
        ...
        cy.contains('Nuevo Paquete de Despliegue').click({force:true})
        cy.get('#__xmlview5--txtDisplayName-__clone20-inner').type('DP_Prueba01')
        ...
        //Libero Contenedor desde el Arbol
        cy.wait(2000)
        ...
        cy.wait(2000)
        cy.get('#__xmlview5--cbDP-inner').type('DP_Prueba01{enter}')
        cy.get('#__xmlview5--save-inner').click()
