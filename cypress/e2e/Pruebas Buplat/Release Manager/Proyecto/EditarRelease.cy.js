...
describe('Ingresamos Login',() =>{
    it('Editar Release',() =>{
        ...
        cy.contains('Liberacion15').click()
        cy.get('#__xmlview5--edit-inner').click()
        cy.get('#__xmlview5--txtName-__clone40-inner').clear()
        cy.get('#__xmlview5--txtName-__clone40-inner').type('Liberacion15')
        cy.get('#__xmlview5--txtDisplayName-__clone42-inner').clear()
        ...
        cy.get('#__xmlview5--ReleaseID-inner').clear()
