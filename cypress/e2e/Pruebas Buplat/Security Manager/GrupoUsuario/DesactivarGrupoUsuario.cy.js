...
describe('Ingresamos Login',() =>{
    it('Desactivar Grupo de Usuario',() =>{
        ...
        cy.get('#__xmlview6--txtName-__clone2-inner').type('RolCompuesto2025')     
        cy.get('#__xmlview6--txtDisplayName-__clone4-inner').type('RolCompuesto2025')
        cy.get('#__xmlview6--userGroupIsActive-handle').click({force:true})     
        cy.get('#__xmlview6--save-inner').click()
        cy.get('#__button17-inner').click()
        cy.get('#__xmlview6--searchText-I').type('RolCompuesto2025')
