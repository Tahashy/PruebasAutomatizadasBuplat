...
describe('Ingresamos Login',() =>{
    it('Crear Grupo de Usuario',() =>{
        ...
        cy.contains('Información del Inicio de Sesión').click({force: true})
        cy.wait(3000)
        cy.get('#__xmlview6--buserUsername-inner').type('ttester')
        cy.get('#__element1 > .sapUiFormCLCellsL9').type('1234')
        //cy.get('#__xmlview6--buserPassword-inner').scrollIntoView() .type('1234')
